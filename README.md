# Creator Assertions Working Group :: User Experience Guidance

This repository contains the source material for the current working draft of the [Creator Assertions Working Group](https://cawg.io/)'s user experience guidance. A rendered version of this specification can be found [here](https://cawg.io/specs/ux-guidance/draft).
